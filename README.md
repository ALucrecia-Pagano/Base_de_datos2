...
- **Parte 2** (Lucas) — Lectura crítica de planes de join interpretados por IA. *Pendiente.*
...
DUIA consolidada de las partes completas en `DUIA_TP4.md` (con la Parte 2 marcada como pendiente).
