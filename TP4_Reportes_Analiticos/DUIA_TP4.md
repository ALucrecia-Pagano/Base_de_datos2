...
`Parte1/DUIA_Parte1.md`); la Parte 2 queda pendiente de Lucas; las
...
*Pendiente — a completar cuando Lucas suba su trabajo.*
...
**Ver también:** `Parte3/consulta_a_ranking.sql` y
...
**Ver también:** `Parte4/analisis_optimizacion.md` (recorrido completo
