-- TP5 - Parte B: datos de prueba para verificar equivalencia con filas reales.
-- Sin esto, v_usuario_publico y v_pedido_usuario se verificaban con la
-- tabla usuario en un estado que no probaba nada util (ver duia.md, Punto 2
-- de la auditoria): en foodstore_tp3_carga ya habia 2 filas administrativas
-- (admin@foodstore.com, vero@foodstore.com) que no coinciden con ningun
-- cliente, asi que el JOIN de v_pedido_usuario daba 0 filas de cualquier
-- forma. Estas 5 filas agregan casos reales: usuarios que si matchean con
-- un cliente existente, uno que no matchea con nadie, y uno eliminado que
-- matchea pero debe quedar filtrado.
--
-- Los mails se tomaron de clientes reales existentes en foodstore_tp3_carga:
